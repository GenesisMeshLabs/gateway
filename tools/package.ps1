...
try {
    $files = @('README.md','docs/distribution.md','docs/operations.md','docs/services.md','docs/mesh.md','docs/federation.md','ui/openapi.json','ui/services.json','deploy/compose.yml','deploy/kubernetes.yaml')
